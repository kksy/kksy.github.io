...
The following is the result of the <a href="#code-generated-by-claude">HTML file</a>:
...
## Mistake 2:  Built the UI Before Understanding the Behaviour
...
Keyboard navigation, an alternative to a mouse, is important for people with mobility impairments. It can get confusing when the focus of the page is inconsistent. Moreover, having the wrong focus order also affects screen reader users, who might lose track of where they are on the page. Read more on <a href="https://www.w3.org/WAI/WCAG22/Understanding/focus-order.html">Focus Order (Level A)</a>

When I first published this article, my initial assumption was that the focus should be on the sixth link after the list expands. Shouldn’t the next item be the more logical continuation? 

<video
  controls
  width="250"
  aria-label="Demo of Focus Remaining on the Next Revealed Item"
  aria-details="transcript-fixed"
  poster="./focus-order-alternative-preview.png">
  <source src="./focus-order-alternative.mp4" type="video/mp4" />
</video>
<details id="transcript-fixed">
   <summary>Transcript</summary>
   <p>Focus ring stays on the 6th item after clicking "Show more"</p>
   …
</details>

Upon further research, I think the answer is really more nuanced: 

- Keeping it on the toggle button allows the user to collapse the items easily.
- Moving to the first revealed items makes navigation simpler.

Ultimately, testing with real keyboard and screen reader users would reveal the better experience.
...
I modified the section on focus order to show a more nuanced opinion
